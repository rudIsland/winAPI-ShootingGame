...
class BulletPlayerAimShot : public IBulletShot
{
public:
	BulletPlayerAimShot(CTexture* tBulletTexture, float tDamage, float tSpeed, float tFireInterval);
	~BulletPlayerAimShot() override;
	...
	inline void SetBulletCount(const int tBulletCount) { mBulletCount = tBulletCount; }
