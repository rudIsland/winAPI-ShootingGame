...
class BulletTwoStraightShot : public IBulletShot
{
public:
	BulletTwoStraightShot(CTexture* tBulletTexture, float tDamage, float tSpeed, float tFireInterval);
	~BulletTwoStraightShot() override;
