...
class BulletRoundShot : public IBulletShot
{
public:
	BulletRoundShot(CTexture* tBulletTexture, float tDamage, float tSpeed, float tFireInterval, int tBulletCount, float tRotateAngle);
	~BulletRoundShot() override;
